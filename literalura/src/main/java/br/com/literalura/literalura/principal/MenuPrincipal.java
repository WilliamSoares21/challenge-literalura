...
// } else {
// livros.forEach(l -> System.out.println("Título: " + l.getTitulo() + " |
...
// " (" + a.getAnoNascimento() + " - " + (a.getAnoFalecimento() != null ?
// a.getAnoFalecimento() : "") + ")");
//
//
...
//
// System.out.println("Livros: " + (titulosLivros.isEmpty() ? "Nenhum livro
// vinculado" : titulosLivros));
// System.out.println();
// });
// }
// }
...
// System.out.println("\nRANKING TOP 10:");
// top10.forEach(l -> System.out.println(l.getNumeroDownloads() + " downloads -
// " + l.getTitulo()));
// }
//
